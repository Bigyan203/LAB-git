...
{ 
	...
	PrintHospitalBycity("Jawalakhel", hospitals); 
...
{ 
	...
	// the user data 
	string patient_Name[] = { "Ramesh", "Suresh", "Sarita", "Serena" }; 
	int patient_Id[] = { 2, 3, 4, 1 }; 
	string patient_Contact[] 
		= { "9810987879", "985100008", "9853676889", 
			"9867675875" }; 
	int bookingCost[] = { 1000, 1200, 1100, 600 }; 

	string hospital_Name[] = { "Nidan", "Nemkul", "Alka", "Sumeru" }; 
	string locations[] = { "Jawalakhel", "Mangalbazar", 
						"Jawalakhel ", "Pulchowk" }; 
	int beds[] = { 4, 5, 6, 9 }; 
	...
	string hospital_Contact[] 
		= { "123445", "677869", "76976", 
			"658659" }; 
	string doctor_Name[] = { "Dinesh", "Malu", "KAlu", "Selmon" }; 
